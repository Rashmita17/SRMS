...
<span class="labels" style="color:white;">Name : <?php echo $name;?><br>Roll No.: <?php echo $roll;?><br>Semester : <?php echo $sem;?></span>
...
<tr><td class="labels" style="text-decoration:underline;color:white;">Subject</td><td class="labels" style="text-decoration:underline;color:white;">Marks</td></tr>
